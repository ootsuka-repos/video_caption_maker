...
def predict_image_tags(image_path, model_repo=MODEL_REPO, general_thresh=0.55, character_thresh=0.85):
    ...
    Args:
        ...
        general_thresh (float): 一般タグの閾値 (デフォルト: 0.35)
...
def main():
    # 画像のパス
    image_path = r"C:\Users\user\Downloads\caption\test.jpg"

    # タグ予測を実行
    results = predict_image_tags(image_path)
    
    # 結果を表示
    print("一般タグ:", results['tags'])
    #print("\n評価:", results['rating'])
    #print("\nキャラクター:", results['characters'])
    print("\nすべての一般タグ:", results['general_tags'])
